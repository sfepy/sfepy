...
from sfepy.discrete.dg.dg_conditions import DGEssentialBC
...
left_bc_u = DGEssentialBC('left_fix_u', left, {'u.all': bcFun_left})
# right_bc_u = DGEssentialBC('left_fix_u', right, {'u.all': bcfun_right})
# top_bc_u = DGEssentialBC('left_fix_u', top, {'u.all': bcfun_top})
# bottom_bc_u = DGEssentialBC('left_fix_u', bottom, {'u.all': bcfun_bottom})
