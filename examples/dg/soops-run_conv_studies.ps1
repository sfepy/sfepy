...
soops-run -o .\$od\example_dg_advection1D "problem_file='advection/example_dg_advection1D', --cfl=[0.1, .5], --adflux=[0.0, 0.5, 1.0] , --limit=[@defined, @undefined], mesh=[$mt1D01_2], output_dir='$od/example_dg_advection1D/%s'" .\run_dg_conv_study.py
...
soops-run -o .\$od\example_dg_quarteroni4 "problem_file='advection/example_dg_quarteroni4', --cw=[1, 10, 100, 1e3, 1e4, 1e5], --diffcoef=[1e-3, 1e-2, .1, 1], mesh=[$mt2D01_4, $ms2D01_4], output_dir='$od/example_dg_quarteroni4/%s'" .\run_dg_conv_study.py
...
soops-run -o .\$od\$ex -c '--cw + --diffscheme' "problem_file='burgess/$ex', --dt=[1e-5], --cw=[1, 5 , 15], --diffcoef=[1e-2, 0.1], --diffscheme=[symmetric, non-symmetric, incomplete], mesh=[$mt2D11_4, $ms2D11_4], output_dir='$od/$ex/%s'" .\run_dg_conv_study.py
...
soops-run -o .\$od\$ex "problem_file='diffusion/$ex', --cw=[1, 10, 100, 1e3, 1e4, 1e5], mesh=[$mt2D01_4, $ms2D01_4], output_dir='$od/$ex/%s'" .\run_dg_conv_study.py
