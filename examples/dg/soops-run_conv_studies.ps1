...
soops-run -o .\soops_tests\$ex "problem_file='burgess/$ex', --adflux=[0.0, 0.5, 1.0], --limit=[@defined, @undefined], --dt=[1e-5], --cw=[1, 10, 100, 1e3, 1e4, 1e5], --diffcoef=[1e-3, 1e-2], mesh=[$mt2D11_4, $ms2D11_4], output_dir='soops_tests/$ex/%s'" .\run_dg_conv_study.py

$ex="example_dg_diffusion1D_hesthaven.py"
soops-run -o .\soops_tests\$ex "problem_file='diffusion/$ex', --cfl=[1e-3, 1e-2], --cw=[1, 10, 100, 1e3, 1e4, 1e5], --diffcoef=[1e-3, 1e-2], mesh=['mesh/mesh_tensr_1D_0-2pi_100.vtk'], --refines='[0,1,2]', output_dir='soops_tests/$ex/%s'" .\run_dg_conv_study.py

$ex="example_dg_diffusion2D_hartmann"
soops-run -o .\soops_tests\$ex "problem_file='diffusion/$ex', --cw=[1, 10, 100, 1e3, 1e4, 1e5], --diffcoef=[1e-3, 1e-2], mesh=[$mt2D01_4, $ms2D01_4], output_dir='soops_tests/$ex/%s'" .\run_dg_conv_study.py
