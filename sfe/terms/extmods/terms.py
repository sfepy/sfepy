...
def dw_adj_convect1(*args):
  """
    dw_adj_convect1(FMField out, FMField state, int32 offset, FMField velocity, 
        int32 voffset, FMField bf, VolumeGeometry vg, 
        int32 conn, int32 elList, int32 isDiff) -> int32
    """
  return _terms.dw_adj_convect1(*args)

def dw_adj_convect2(*args):
  """
    dw_adj_convect2(FMField out, FMField state, int32 offset, FMField velocity, 
        int32 voffset, FMField bf, VolumeGeometry vg, 
        int32 conn, int32 elList, int32 isDiff) -> int32
    """
  return _terms.dw_adj_convect2(*args)

def dw_st_adj_supg_c(*args):
  """
    dw_st_adj_supg_c(FMField out, FMField stateU, int32 offsetU, FMField stateW, 
        int32 offsetW, FMField coef, FMField bf, 
        VolumeGeometry vg, int32 conn, int32 elList, 
        int32 isDiff) -> int32
    """
  return _terms.dw_st_adj_supg_c(*args)

def dw_st_adj1_supg_p(*args):
  """
    dw_st_adj1_supg_p(FMField out, FMField stateP, int32 offsetP, FMField stateW, 
        int32 offsetW, FMField coef, FMField bf_w, 
        VolumeGeometry vg_w, VolumeGeometry vg_p, 
        int32 conn_w, int32 conn_p, int32 elList, 
        int32 isDiff) -> int32
    """
  return _terms.dw_st_adj1_supg_p(*args)

def dw_st_adj2_supg_p(*args):
  """
    dw_st_adj2_supg_p(FMField out, FMField stateU, int32 offsetU, FMField stateR, 
        int32 offsetR, FMField coef, FMField bf_u, 
        VolumeGeometry vg_u, VolumeGeometry vg_r, 
        int32 conn_u, int32 conn_r, int32 elList, 
        int32 isDiff) -> int32
    """
  return _terms.dw_st_adj2_supg_p(*args)

def d_of_nsMinGrad(*args):
  """
    d_of_nsMinGrad(FMField out, FMField velocity, int32 offset, float64 viscosity, 
        VolumeGeometry vg, int32 conn, int32 elList) -> int32
    """
  return _terms.d_of_nsMinGrad(*args)

def d_of_nsSurfMinDPress(*args):
  """
    d_of_nsSurfMinDPress(FMField out, FMField pressure, int32 offset, float64 weight, 
        float64 bpress, FMField bf, SurfaceGeometry sg, 
        int32 conn, int32 elList, int32 isDiff) -> int32
    """
  return _terms.d_of_nsSurfMinDPress(*args)

def d_sd_div(*args):
  """
    d_sd_div(FMField out, FMField stateU, int32 offsetU, FMField stateP, 
        int32 offsetP, FMField vecMV, int32 offsetMV, 
        FMField bf_p, VolumeGeometry vg_u, 
        VolumeGeometry vg_p, VolumeGeometry vg_mv, int32 conn_u, 
        int32 conn_p, int32 conn_mv, int32 elList, 
        int32 mode) -> int32
    """
  return _terms.d_sd_div(*args)

def d_sd_div_grad(*args):
  """
    d_sd_div_grad(FMField out, FMField stateU, int32 offsetU, FMField stateW, 
        int32 offsetW, FMField vecMV, int32 offsetMV, 
        float64 viscosity, VolumeGeometry vg_u, 
        VolumeGeometry vg_mv, int32 conn_u, int32 conn_mv, 
        int32 elList, int32 mode) -> int32
    """
  return _terms.d_sd_div_grad(*args)

def d_sd_convect(*args):
  """
    d_sd_convect(FMField out, FMField stateU, int32 offsetU, FMField stateW, 
        int32 offsetW, FMField vecMV, int32 offsetMV, 
        FMField bf_u, FMField bf_w, VolumeGeometry vg_u, 
        VolumeGeometry vg_w, VolumeGeometry vg_mv, 
        int32 conn_u, int32 conn_w, int32 conn_mv, 
        int32 elList, int32 mode) -> int32
    """
  return _terms.d_sd_convect(*args)

def d_sd_testPQ(*args):
  """
    d_sd_testPQ(FMField out, FMField stateP, int32 offsetP, FMField stateQ, 
        int32 offsetQ, FMField vecMV, int32 offsetMV, 
        FMField bf, VolumeGeometry vg, int32 conn, 
        int32 elList, int32 mode) -> int32
    """
  return _terms.d_sd_testPQ(*args)

def d_sd_st_grad_div(*args):
  """
    d_sd_st_grad_div(FMField out, FMField stateU, int32 offsetU, FMField stateW, 
        int32 offsetW, FMField vecMV, int32 offsetMV, 
        float64 gamma, VolumeGeometry vg_u, 
        VolumeGeometry vg_mv, int32 conn_u, int32 conn_mv, 
        int32 elList, int32 mode) -> int32
    """
  return _terms.d_sd_st_grad_div(*args)

def d_sd_st_supg_c(*args):
  """
    d_sd_st_supg_c(FMField out, FMField stateU, int32 offsetU, FMField stateB, 
        int32 offsetB, FMField stateW, int32 offsetW, 
        FMField vecMV, int32 offsetMV, FMField bf_u, 
        FMField coef, VolumeGeometry vg_u, 
        VolumeGeometry vg_mv, int32 conn_u, int32 conn_mv, 
        int32 elList, int32 mode) -> int32
    """
  return _terms.d_sd_st_supg_c(*args)

def d_sd_st_pspg_c(*args):
  """
    d_sd_st_pspg_c(FMField out, FMField stateU, int32 offsetU, FMField stateB, 
        int32 offsetB, FMField stateR, int32 offsetR, 
        FMField vecMV, int32 offsetMV, FMField bf_u, 
        FMField coef, VolumeGeometry vg_u, 
        VolumeGeometry vg_r, VolumeGeometry vg_mv, int32 conn_u, 
        int32 conn_r, int32 conn_mv, int32 elList, 
        int32 mode) -> int32
    """
  return _terms.d_sd_st_pspg_c(*args)

def d_sd_st_pspg_p(*args):
  """
    d_sd_st_pspg_p(FMField out, FMField stateP, int32 offsetP, FMField stateR, 
        int32 offsetR, FMField vecMV, int32 offsetMV, 
        FMField coef, VolumeGeometry vg_p, 
        VolumeGeometry vg_mv, int32 conn_p, int32 conn_mv, 
        int32 elList, int32 mode) -> int32
    """
  return _terms.d_sd_st_pspg_p(*args)

def dw_hdpm_a(*args):
  """
    dw_hdpm_a(FMField out, float64 coef, FMField strain, FMField mtxD, 
        VolumeGeometry vg, int32 elList, int32 isDiff) -> int32
    """
  return _terms.dw_hdpm_a(*args)

def d_hdpm_a(*args):
  """
    d_hdpm_a(FMField out, float64 coef, FMField strainV, FMField strainU, 
        FMField mtxD, VolumeGeometry vg, int32 elList) -> int32
    """
  return _terms.d_hdpm_a(*args)

def dw_hdpm_b1(*args):
  """
    dw_hdpm_b1(FMField out, float64 coef, FMField pressure_qp, FMField bf, 
        FMField mtxD, VolumeGeometry vg, int32 elList, 
        int32 isDiff) -> int32
    """
  return _terms.dw_hdpm_b1(*args)

def dw_hdpm_b2(*args):
  """
    dw_hdpm_b2(FMField out, float64 coef, FMField strain, FMField bf, 
        FMField mtxD, VolumeGeometry vg, int32 elList, 
        int32 isDiff) -> int32
    """
  return _terms.dw_hdpm_b2(*args)

def dw_hdpm_d(*args):
  """
    dw_hdpm_d(FMField out, float64 coef, FMField state, int32 offset, 
        FMField mtxD, VolumeGeometry vg, int32 conn, 
        int32 elList, int32 isDiff) -> int32
    """
  return _terms.dw_hdpm_d(*args)

def d_hdpm_d(*args):
  """
    d_hdpm_d(FMField out, float64 coef, FMField gradP1, FMField gradP2, 
        FMField mtxD, VolumeGeometry vg, int32 elList) -> int32
    """
  return _terms.d_hdpm_d(*args)

def dw_hdpm_d2(*args):
  """
    dw_hdpm_d2(FMField out, FMField mtxD, VolumeGeometry vg, int32 conn, 
        int32 elList) -> int32
    """
  return _terms.dw_hdpm_d2(*args)

def dw_hdpm_g(*args):
  """
    dw_hdpm_g(FMField out, float64 coef, FMField pressure_qp, FMField bf, 
        FMField mtxD, VolumeGeometry vg, int32 elList, 
        int32 isDiff) -> int32
    """
  return _terms.dw_hdpm_g(*args)

def de_hdpm_dvel(*args):
  """
    de_hdpm_dvel(FMField out, FMField state, int32 offset, FMField mtxD, 
        VolumeGeometry vg, int32 conn, int32 elList) -> int32
    """
  return _terms.de_hdpm_dvel(*args)

def d_hdpm_surfdvel(*args):
  """
    d_hdpm_surfdvel(FMField out, FMField state, int32 offset, FMField mtxD, 
        SurfaceGeometry sg, int32 fis, int32 faceList, 
        int32 conn, int32 elList) -> int32
    """
  return _terms.d_hdpm_surfdvel(*args)
