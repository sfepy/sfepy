...
% Meření numerického řádu přesnosti probíhá na 5 sítích, na každé je
%   dvojnásobný počet prvků oproti předchozí.
% Pro určení řádu je brána max norma a L2 norma z rozdílu přesného řešení 
...
for i = 1:5
    ...
    h(i) = 1/(e);
    fprintf('\n===========================================================\n');
    fprintf('            Výpočet s %d prvky, tj. h = %.5f\n', e, h(i));
    fprintf('===========================================================\n\n');
    X = linspace(0,1,e + 1)';
    % POČÁTEČNÍ PODMÍNKA ... SINUS:
    pp = @(x) sin(x * 2 * pi);
...
fprintf('\n===========================================================\n');
fprintf('                  Numerický řád přesnosti:\n');
fprintf('===========================================================\n\n');
for i = 2:5
