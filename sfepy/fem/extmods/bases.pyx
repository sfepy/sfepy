...
cpdef find_ref_coors(np.ndarray[float64, mode='c', ndim=2] ref_coors,
    ...
    cdef _f.FMField e_coors[1], _mesh_coors[1], xi[1], dest_point[1]
    cdef _f.FMField eref_coors[1], _ref_coors[1],
    cdef _f.FMField bc[1], base1d[1], mtx_i[1], bf[1]
    ...
    _f.fmf_pretend(dest_point, n_point, 1, 1, dim, &coors[0, 0])

    _f.fmf_pretend(_ref_coors, n_point, 1, 1, dim, &ref_coors[0, 0])
...
cpdef evaluate_in_rc(np.ndarray[float64, mode='c', ndim=2] out,
    ...
    cdef np.ndarray[int32, mode='c', ndim=2] conn
    cdef np.ndarray[int32, mode='c', ndim=2] nodes
    cdef _f.FMField eref_coors[1], src[1]
    cdef _f.FMField _ref_coors[1], _out[1], bc[1], base1d[1], mtx_i[1], bf[1]
