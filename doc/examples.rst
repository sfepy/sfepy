...
- `Numerical simulation of viscous flow in deformable double porous media <https://sfepy.org/sfepy_examples/example_perfusion_BDB/>`_ (2020)
- `Numerical simulations of large-deforming fluid-saturated porous media using an Eulerian incremental formulation <https://sfepy.org/sfepy_examples/example_largedef_porodyn/>`_ (2017)
