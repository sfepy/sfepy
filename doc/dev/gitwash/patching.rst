...
You've discovered a bug or something else you want to change in SfePy_ - excellent!
...
Then, send the generated patch files to the `SfePy mailing list`_ - where we will thank you warmly.
...
#. If you don't already have one, clone a copy of the SfePy_ repository::
...
#. Finally, make your commits into patches.  You want all the commits
   ...
   Send these files to the `SfePy mailing list`_.
...
Fork the SfePy_ repository on github_ - :ref:`forking`.  Then::
