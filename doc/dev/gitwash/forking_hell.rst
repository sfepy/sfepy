...
specifics for the SfePy_ project, and to suggest some default names.
...
Create your own forked copy of SfePy_
=========================================

#. Log into your github_ account.
#. Go to the SfePy_ github home at `SfePy github`_.
#. Click on the *fork* button:

   .. image:: forking_button.png

   Now, after a short pause and some 'Hardcore forking action', you
   should find yourself at the home page for your own forked copy of SfePy_.
